      ...
      <div className='w-full bg-[#E5F5ED] rounded-2xl flex flex-col items-center justify-center p-[clamp(16px,_4vw,_48px)]'>
        ...
        <div className='w-full'>
          <div className='flex gap-5 mt-[clamp(16px,_5vw,_48px)] w-full justify-center items-center max-[650px]:flex-col max-[650px]:gap-2'>
            <input type='email' placeholder='Enter your email' className='flex-1 max-w-[431px] p-4 text-[20px] border border-[#A0A0A0] bg-white rounded-md placeholder:text-[#D0D0D0] max-[650px]:w-full'/>

            <div className='flex gap-0.5 text-[14px] mt-1 min-[650px]:hidden'>
              <p className='max-[650px]:text-[#717171]'>
                We protect your data in our 
              </p>
              <Link href='/privacy' className='italic underline underline-offset-4 max-[650px]:text-[#717171]'>
                privacy policy
              </Link>
            </div>

            <button className='btn-primary min-[650px]:self-stretch max-[650px]:h-15 max-[650px]:my-3'>Subscribe Now</button>
